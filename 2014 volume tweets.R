...
hashtags_2014 <- subset(hashtags, theYear == 2014)
hashtags_post <- subset(hashtags_2014, (theMonth == 9 & theDay >= 30) | (theMonth == 10 & theDay <= 31))
...
df <- rename(df, c("hashtags_post.Date"="Date", "hashtags_post.RoyalsCount"="#Royals", "hashtags_post.TakeTheCrownCount"="#TakeTheCrown"))
                   ...
                   qplot(hashtags_post$Date, hashtags_post$RoyalsCount, xlab = "Month - Date", ylab="Number of Tweets", main="Volume of Tweets Containing #Royals - 2014")
                   qplot(hashtags_post$Date, hashtags_post$WorldSeriesCount, xlab = "Month - Date", ylab="Number of Tweets", main="Volume of Tweets Containing #WorldSeries - 2014")
                   qplot(hashtags_post$Date, hashtags_post$TakeTheCrownCount, xlab = "Month - Date", ylab="Number of Tweets", main="Volume of Tweets Containing #TakeTheCrown - 2014")
